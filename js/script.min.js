var mySwiper = new Swiper(".start__container", {
    ...
    mySwiperGAL = new Swiper(".gallery__right", {
        ...
        breakpoints: {
            ...
            1024: { spaceBetween: 30, slidesPerView: 2, slidesPerGroup: 2 },
...
contries.forEach((e) => {
    e.addEventListener("click", function () {
        contries.forEach((e) => {
            e.classList.remove("history__img__active");
        }),
            e.classList.add("history__img__active");
    });
});
$('.link-bottom').on('click', function (e) {
    $('.link-bottom').removeClass('active-icon');
    $(e.target).addClass('active-icon');
...
window.addEventListener("DOMContentLoaded", function () {
    $(".history__button").click(function () {
        $(this).toggleClass('history__button-active');
...
window.addEventListener("scroll", function () {
    if (
        ...
        ymaps.ready(function () {
            var e = new ymaps.Map("map", { center: [55.76, 37.64], zoom: 15 });
...
$(document).ready(function () {
    ...
    if ($(window).width() <= 450) {
        ...
        $('body').on('click', '.active-2', function () {
            ...
            $('.editions h2').removeClass('h2-active');
        });
